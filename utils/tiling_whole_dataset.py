...
def splitter(target, target_upfolder, ext, ratio):
    ...
    imnames = [path.replace('\\', '/') for path in imnames]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-source", default="data/areca_tiling", help = "Source folder with images and labels needed to be tiled")
    parser.add_argument("-target", default="data/areca_tiling_2048/sliced", help = "Target folder for a new sliced dataset")
