...
class IOUloss:
    ...
    def __call__(self, box1, box2): # The __call__ method allows objects to be callable, providing a convenient way to make instances of a class behave like functions.
        ...
        if box1.shape[0] != box2.shape[0]:
            ...
            if self.box_format == 'xyxy':
                b1_x1, b1_y1, b1_x2, b1_y2 = torch.split(box1, 1, dim=-1) # dim 0 - rows, dim 1 - columns, dim -1 is columns, dim -2 is rows
